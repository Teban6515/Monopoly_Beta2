...
export class GameController {
  ...
  async bootstrap() {
    try {
      ...
      console.error(err);
      alert("No fue posible obtener datos del backend.");
    }
  }
  ...
  payRent(payer, owner, rent) {
    ...
    if (payer.money >= rent) {
      payer.money -= rent;
      owner.money += rent;
      this.updateRanking(payer);
      this.updateRanking(owner);
      UI.renderPlayers(this.game);
